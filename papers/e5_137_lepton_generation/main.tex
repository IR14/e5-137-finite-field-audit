...
limit recovers the Mendeleev\textendash{}Clapeyron equation and Boltzmann entropy
...
The release uses an energy-cost accounting estimate based on the Landauer lower
bound for erasing $B$ bits at temperature $T$,
\begin{equation}
...
\end{equation}
The repaired finite-field state used in HYP-007 stores
...
\begin{equation}
    ...
    0.4111824864372086,
\end{equation}
corresponding to a storage-bit accounting reduction of
